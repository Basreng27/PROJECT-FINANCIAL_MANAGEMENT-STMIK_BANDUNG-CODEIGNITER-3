                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Pembayaran Melalui Sisa Pembayaran</h4>
                                ...
                                <div class="card-body">
                                    <div class="basic-elements">
                                        ...
                                        <?php } ?> -->
                                        <form action="<?php echo base_url() ?>sisa_pembayaran" method="POST">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <?php
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label>Jumlah Sisa Pembayaran</label>
                                                            <input type="text" class="form-control" value="<?php echo $data->sisa_pembayaran ?>" name="sisa_pembayaran" readonly>
                                                        </div>
                                                        <div class="form-group">
