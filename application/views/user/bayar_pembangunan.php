                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-elements">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <?php echo form_open("user/bayar_pembangunan", array('enctype' => 'multipart/form-data')); ?>
                                                <?php
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Jumlah Tunggakan Pembangunan</label>
                                                        <input type="text" class="form-control" value="<?php echo $data->tunggakan_pembangunan ?>" name="tunggakan" readonly>
                                                    </div>
                                                <?php
                                                }
                                                ?>
                                                ...
                                                <table cellpadding="8">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="file" name="bukti_pembayaran_pembangunan"></td>
                                                    </tr>
                                                </table>
