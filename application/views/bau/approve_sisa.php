                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Approve Sisa Pembayaran</h4>

                                </div>
                                <div class="card-body">
                                    <div class="basic-elements">
                                        <form action="<?php echo base_url() ?>proses_approve_sisa" method="POST">
                                            <?php foreach ($data_approve as $data) {
                                            ?>
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <!-- <div class="form-group">
                                                            ...
                                                            <input type="hidden" class="form-control" name="bukti_pembayaran" value="<?php echo $data->bukti_pembayaran ?>" readonly>
                                                            <td>
                                                                <?php
