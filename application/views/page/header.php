    ...
    <div class="nano">
        <div class="nano-content">
            <ul>
                ...
                <li><a href="<?php echo base_url() ?>home_admin"><i class="ti-calendar"></i>Dashboard </a></li>

                <li><a class="sidebar-sub-toggle"><i class="ti-user"></i>Admin<span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="<?php echo base_url() ?>tambah_admin">Tambah Admin / BAU</a></li>
                        <li><a href="<?php echo base_url() ?>daftar_admin">Daftar Admin </a></li>
                    </ul>
                </li>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-desktop"></i>Pembagunan <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="<?php echo base_url() ?>tambah_pembangunan">Tambah Pembangunan</a></li>
                        <li><a href="<?php echo base_url() ?>daftar_pembangunan">Daftar Pembangunan </a></li>
                    </ul>
                </li>
