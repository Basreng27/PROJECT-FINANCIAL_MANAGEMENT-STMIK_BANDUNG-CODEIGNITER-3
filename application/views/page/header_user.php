    ...
    <div class="nano">
        <div class="nano-content">
            <ul>
                ...
                <li><a href="<?php echo base_url() ?>home_user"><i class="ti-calendar"></i> Dashboard </a></li>
                <li><a href="<?php echo base_url() ?>informasi_pembayaran"><i class="ti-email"></i> Informasi Pembayaran</a></li>
                <li><a href="<?php echo base_url() ?>riwayat_pembayaran_mhs"><i class="ti-calendar"></i> Riwayat Pembayaran</a></li>
                    ...
                    <div class="dropdown dib">
                        <div class="header-icon" data-toggle="dropdown">
                            <span class="user-avatar">
                                <?php
                                $username_mahasiswa = $this->session->userdata('username');

                                $nama = $this->M_user->get_nama($username_mahasiswa)->result();
